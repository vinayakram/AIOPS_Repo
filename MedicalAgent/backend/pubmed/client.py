"""
PubMed E-utilities client for the MedicalAgent backend supporting article search, full-detail
fetching, and related-article link retrieval. Parses PubMed XML responses to extract PMIDs,
titles, abstracts, authors, journals, and publication years. Link data is used to build
citation graphs for PageRank scoring.

MedicalAgentバックエンド向けのPubMed E-utilitiesクライアント。論文検索・詳細取得・関連論文
